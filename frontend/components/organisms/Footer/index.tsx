    ...
    <footer className="bg-[#632020] text-white py-16 px-24 flex flex-col ">
      <div className="container flex flex-col space-y-5">
        <div className="flex items-center justify-between">
          <div className="flex flex-col space-y-4 items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0">
            <h2 className="text-6xl font-bold mb-4">Join The Revolution</h2>
            ...
            <a
              href="#"
              className="bg-[#f6b73c] text-black text-xl  px-6 py-3 w-[50%] rounded-lg hover:bg-[#d9972c] transition"
            >
              Join ICP Kenya Hub
            </a>
          </div>
