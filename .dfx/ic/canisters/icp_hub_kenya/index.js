...
import { idlFactory } from './icp_hub_kenya.did.js';
export { idlFactory } from './icp_hub_kenya.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_HUB_KENYA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_hub_kenya.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_hub_kenya canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_hub_kenya.did.js")._SERVICE>}
 */
export const icp_hub_kenya = createActor(canisterId);
